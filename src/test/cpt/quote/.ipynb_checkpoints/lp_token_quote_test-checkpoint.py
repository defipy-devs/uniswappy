...
from python.prod.cpt.quote import LPTokenQuote
import numpy as np 
...
class Test_LPTokenQuote(unittest.TestCase):
    ...
    def test_lp_token_quote0(self):
        ...
        amt_lp = LPTokenQuote().get_x(lp, 100)        
        self.assertEqual(round(amt_lp,8), round(15.832072192775247, 8))         
        
    def test_lp_token_quote1(self):
        
        sys1 = ERC20("SYS", "0x09") 
        dai1 = ERC20("DAI", "0x111")
        lp, lp1, lp2, lp3, lp4, lp5 = self.setup(sys1, dai1)
               
        amt_lp = LPTokenQuote().get_x(lp1, 100)        
        self.assertEqual(round(amt_lp,8), round(19.73520724751311, 8))    
        
    def test_lp_token_quote2(self):
        
        sys1 = ERC20("SYS", "0x09") 
        dai1 = ERC20("DAI", "0x111")
        lp, lp1, lp2, lp3, lp4, lp5 = self.setup(sys1, dai1)
               
        amt_lp = LPTokenQuote().get_x(lp2, 100)        
        self.assertEqual(round(amt_lp,8), round(6.685786389212807, 8))    
        
    def test_lp_token_quote3(self):
        
        sys1 = ERC20("SYS", "0x09") 
        dai1 = ERC20("DAI", "0x111")
        lp, lp1, lp2, lp3, lp4, lp5 = self.setup(sys1, dai1)
               
        amt_lp = LPTokenQuote().get_x(lp3, 100)        
        self.assertEqual(round(amt_lp,8), round(6.531424850346628, 8))    
        
    def test_lp_token_quote4(self):
        
        sys1 = ERC20("SYS", "0x09") 
        dai1 = ERC20("DAI", "0x111")
        lp, lp1, lp2, lp3, lp4, lp5 = self.setup(sys1, dai1)
               
        amt_lp = LPTokenQuote().get_x(lp4, 100)        
        self.assertEqual(round(amt_lp,8), round(20.188739134737187, 8))    
        
    def test_lp_token_quote5(self):
        
        sys1 = ERC20("SYS", "0x09") 
        dai1 = ERC20("DAI", "0x111")
        lp, lp1, lp2, lp3, lp4, lp5 = self.setup(sys1, dai1)
               
        amt_lp = LPTokenQuote().get_x(lp5, 100)        
        self.assertEqual(round(amt_lp,8), round(7.947849869211949, 8))            
