...
class Exchange2(DOASYSERC20):
    ...
    def info(self):
        ...
        print(f"Liquidity: {self.reserve0} * {self.reserve1} = {k}\n")
    ...
    def _add_liquidity(self, balance0, balance1, balance0Min, balance1Min):
        ...
        if self.reserve0 == 0 and self.reserve1 == 0:
            ...
            if balance1Optimal <= balance1:                
                assert round(balance1Optimal,8) >= round(balance1Min,8), 'UniswapV2Router: INSUFFICIENT_B_AMOUNT'
                amount0 = balance0
