...
class Test_IndexTokenBurn(unittest.TestCase):
    ...
    def setup_vault(self, lp_tkn, token):
        ...
        ivault.rebase_index_tkn(lp_tkn, token)
        return ivault    
    ...
    def test_burn1(self):
        ...
        self.assertEqual(round(ivault.lp_providers[USER0]['iETH']['amount'],5), 228.89753)
        self.assertEqual(round(ivault.lp_providers[USER0]['ETHTKN-LP']['amount'],5), 1200)
    ...
    def test_burn2(self):
        ...
        self.assertEqual(round(ivault.lp_providers[USER0]['iTKN']['amount'],5), 22889.75275)
